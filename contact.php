...
<body class="bg-dark">
  ...
  <div class="my-5 px-4">
    <h2 class="fw-bold h-font text-center text-warning">CONTACT US</h2>
    ...
    <div class="row">
      <div class="col-lg-6 col-md-6 mb-5 px-4">
        ...
        <div class="bg-secondary rounded shadow p-4">
          ...
          <h5 class="mt-4 text-warning">Call us</h5>
          ...
          <h5 class="mt-4 text-warning">Email</h5>
          <a href="mailto: <?php echo $contact_r['email'] ?>" class="d-inline-block text-decoration-none text-white">
            <i class="bi bi-envelope-fill"></i> <?php echo $contact_r['email'] ?>
          </a>

          <h5 class="mt-4 text-warning">Follow us</h5>
          <?php 
            if($contact_r['tw']!=''){
              echo<<<data
                <a href="$contact_r[tw]" class="d-inline-block text-white fs-5 me-2">
          ...
          <a href="<?php echo $contact_r['fb'] ?>" class="d-inline-block text-white fs-5 me-2">
            <i class="bi bi-facebook me-1"></i>
          </a>
          <a href="<?php echo $contact_r['insta'] ?>" class="d-inline-block text-white fs-5">
